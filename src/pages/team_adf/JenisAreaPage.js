...
clickTambah(){
    console.log(this.state.jnsarea_code)
    this.setState({
...
onCheckChange(e){
    ...
    if(e.target.checked === true){
        this.setState({
            disabledSimpanEditJenisArea :false,
    ...
    setEditJenisArea =  (first_param, second_param,third_param) => async  () => {
        ...
        //2.Ketika sudah terespond oleh backend , maka kita akan melakukan hal ini
            ...
            if(data){
                ...
                alert("Data yang Diubah ERROR !,Mohon Masukan Ulang !");
            }
    }
    boolean = false;
...
updateInputValueKode= (evt) => {
    console.log(this.state.jnsarea_code + ' jnsarea_code')
    this.setState({
...
updateModalWithItemID (
        ...
        inputtedCheckboxAreaClassS
            ...
            this.setState({
                disabledSimpanEditJenisArea :true,
                modal_update :true
            });
...
console.log("MASUK HAPUS JENIS AREA")
    var url = hostUrl+`/HapusJenisArea/${param}`;
    var payload = { 
        jnsarea_userid: "0"
    };
    let data = await fetch(url,{
            ...
            <Card className="mb-3">
                  ...
                  <ModalFooter>
                    ...
                    >
                      ...
                      <ModalFooter>
                        <Button
                          color="primary"
                          onClick={this.insertMasterJenisArea()}
                          disabled={isLoading}
                        >
                          {!isLoading && (
                ...
                >
                  ...
                  <ModalFooter>
                    <Button
                      id="buttonSimpan"
                      color="primary"
                      disabled={this.state.disabledSimpanEditJenisArea}
              ...
              <CardBody>
                ...
                >
                  ...
                  {/* ====================================== LOOPING SEMUA DATA AGAR MASUK KE DALAM TABLE ============================= */}
                  <tbody>
                    {result.map(jnsarea => (
                      <tr align="center">
