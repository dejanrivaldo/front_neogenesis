...
class GPLPage extends React.Component {
  ...
  getListbyPaging(currPage, currLimit) {
    var url =
      hostUrl + `/TampilSemuaDataGPL/page?size=${currLimit}&page=${currPage}`;
    this.isLoading = true;
    fetch(url)
  ...
  insertGPL = param => async () => {
    ...
    if (data) {
      ...
      alert('Data ' + param + ' Error !, Silahkan Mengisi Ulang!');
    }
  };
          ...
          <CardHeader className="d-flex justify-content-between">
              ...
              <ModalFooter>
                ...
                >
                  ...
                  <ModalFooter>
                    <Button
                      color="primary"
                      onClick={this.insertGPL(this.state.inputtedName2)}
                      disabled={isLoading}
                    >
                      {!isLoading && <i className="fa fa-refresh fa-spin"></i>}
                      Ya
            ...
            >
              ...
              <ModalFooter>
                <Button
                  color="primary"
                  onClick={this.deleteGPL(this.state.activeItem_Id)}
                >
                  {!isLoading && <i className="fa fa-refresh fa-spin"></i>}
                  Ya
                </Button>
            ...
            >
              ...
              <ModalFooter>
                <Button
                  ...
                  disabled = {this.state.disabledSimpanEdit}
                >
                  Simpan
                </Button>
                <Modal
                    ...
                    {gpl.gpl_activeyn === 'Y' && (
                      <td>
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            this.openModalWithItemID(gpl.gpl_runningid)
                          }
                        >
                          HAPUS
                        </Button>
