...
openModalTambah(){
    ...
    insertMasterShift = (shift_name) => () => {
        console.log('masuk insert master shift')
        ...
        fetch(url, {
            ...
            if (response.ok) {
                this.setState({
                    ...
                    currentPage : this.state.lastData
                })
    ...
    createCsv = () => {
        let rows = [
            ['Kode Shift', 'Nama Shift']
        ];
        const currentTodos = this.state.result.result;

        currentTodos.forEach((v) => {
            rows.push([v.shift_code, v.shift_name]);
        });
                    ...
                    <Col>
                        <Card className="mb-3">
                            <CardHeader className="d-flex justify-content-between">
                                ...
                                <Button size="sm" onClick={(()=> this.openModalTambah())}>Tambah</Button>
                                <Modal
                                  ...
                                  className={this.props.className}>
                                    ...
                                    <ModalBody>
                                        ...
                                        <Input 
                                        maxLength = '30'
                                        type="namashift" value={this.state.inputtedName} onChange={evt => this.updateInputValue(evt)} name="namashift" placeholder="Nama Shift" />
                                    </ModalBody>
                                    <ModalFooter>
