		...
		return (
			<Card className="m-1 p-4">
				<CardHeader>
					<Row>
						<Col>
							<Label className='mr-3 font-weight-bold'><span style={fontStyle}><span className='mr-3'>CABANG</span>:</span></Label>
				...
				<CardBody>
                    <Row>
                        <Col>
                            <Label className='mr-3 font-weight-bold'><span style={fontStyle}><span className='mr-3'>ALAMAT</span></span> </Label>
					...
					<Row>
                        <Col>
                            ...
                            <Label className= 'mb-4 d-flex justify-content-end'>
                                <Barcode format='CODE39' height={50} displayValue={false} value="http://github.com/kciter" /></Label>
