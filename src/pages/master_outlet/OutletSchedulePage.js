...
// -----------------------------------------------  SHOW ALL DATA --------------------------------------------------------- 
    ...
    enableField=()=>
    {
        var url = hostUrl+`/TampilSemuaDataShiftOutlet`
    ...
    updateInputValueEndShift= (evt) => {
            console.log(evt.target)
            if(evt.target.value > this.state.timeclose && (evt.target.value.substr(0,2) - this.state.startShift.substr(0,2)) > this.state.jamAcuan){
                this.setState({
            ...
            else if((evt.target.value.substr(0,2) - this.state.startShift.substr(0,2)) > this.state.jamAcuan){
                    this.setState({
            ...
            else if(evt.target.value.substr(0,2) < this.state.startShift.substr(0,2)){
                this.setState({
                    endShift    : evt.target.value,
                    endTimeError: true,
                    flagsavebtn : true   
    ...
    updateInputValueEndShiftEdit= (evt) => {
        ...
        else if(evt.target.value.substr(0,2) < this.state.startShiftEdit.substr(0,2)){
            this.setState({
