...
class BusdevPage extends React.Component {
	...
	handleInputAbsoluteNumber = (event) => {
		const name = event.target.name;
		const value = event.target.value;

		this.setState({
			[event.target.name]: Math.abs(value)
		}, () => console.log('HandleInputChange: Input:' + name + ' = ' + name));
	}
	...
	handleSimpanButton = async () => {
		...
		if (data) {
			...
			alert('Data Busdev untuk Outlet ' + this.state.out_name + ' sudah pernah ada');
		}
	...
	simpanPajakReklame = async () => {
		...
		var endDate1 = '1900-01-02';
		var startDate2 = '1900-01-01';
		var endDate2 = '1900-01-02';
	...
	validateSimpan = () => {
		var inputValid = [this.state.sewaout_namapemlokValid,
			this.state.sewaout_grouppemlokValid,
			this.state.sewaout_phonepemlokValid,
			this.state.sewaout_namacp1Valid,
			this.state.sewaout_namacp2Valid,
			this.state.sewaout_bastValid,
	...
	handleOkButton = async () => {
		...
		if (data) {
			...
			alert('Data Busdev yang diubah untuk Outlet ' + this.state.out_name + ' sama');
		}
						...
						<Form>
								...
								<Col md={7}>
									<FormGroup>
										...
										<InputGroup className='d-flex'>
											...
											<InputGroupAddon addonType='append'>
												<Button disabled={this.state.isLoading} onClick={this.toggle('outletSearch')}><MdSearch /></Button>
											</InputGroupAddon>
										</InputGroup>
									</FormGroup>
								</Col>
							...
							<Row form className="mt-3">
								...
								<Col xs={4} md={4}>
									<Input
										disabled={this.state.buttonAddDisabled}
										invalid={this.state.sewaout_grouppemlokInvalid}
										valid={this.state.sewaout_grouppemlokValid}
										type='select'
							...
							<Modal
										...
										<Col md={3}>
											<FormGroup>
												...
												<UncontrolledDropdown direction='up'>
													<DropdownToggle caret disabled={this.state.buttonAddDisabled}>{this.state.jumlahLantaiText}</DropdownToggle>
													<DropdownMenu>
														<DropdownItem
															name='0'
															value='1 lantai'
								...
								<ModalFooter>
									<Button onClick={this.toggle('sewaPeriode')}>Save</Button>
								</ModalFooter>
							</Modal>
							...
							<Modal
									...
									<Row form className="mt-3">
										...
										<Col xs={4} md={4}>
											<Input
												...
												disabled={this.state.buttonAddDisabled || this.state.pjkoutyn1disabled}
									...
									<Row form className="mt-3">
										...
										<Col xs={4} md={4}>
											<Input
												...
												disabled={this.state.buttonAddDisabled || this.state.pjkoutyn2disabled}
								...
								<ModalFooter>
									<Button onClick={this.toggle('pajakReklame')}>Save</Button>
								</ModalFooter>
							...
							<Modal
								...
								<ModalFooter>
									...
									<Button disabled={this.state.isLoading} color='danger' onClick={this.toggle('addPenyewa')}>Cancel</Button>
								</ModalFooter>
							</Modal>
