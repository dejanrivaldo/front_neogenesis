...
class OutletPage extends React.Component {
      ...
      .then(
        data =>
          this.setState({
            ...
            senin: this.resultEyeScheduleSenin(
              data.content[0].schedule_ro_senin,
            ),
            ...
            kamis: this.resultEyeScheduleKamis(
              data.content[0].schedule_ro_kamis,
            ),
            jumat: this.resultEyeScheduleJumat(
              data.content[0].schedule_ro_jumat,
            ),
            sabtu: this.resultEyeScheduleSabtu(
              data.content[0].schedule_ro_sabtu,
            ),

            gudangYN: this.gudangYN(data.content[0].out_robotgdyn),
            allowCredit: this.allowCredit(data.content[0].out_allowcredityn),
            allowPerjanjian: this.allowPerjanjian(
              data.content[0].out_perjanjianyn,
            ),
        ...
        this.setState(
          ...
          () =>
            console.log(
              ...
              this.state.resultEyeout_schedulerorabu +
  ...
  getTableForInputEdit() {
    var url = `http://10.0.111.143:8083/TampilDataPengisianOutlet`;
    // this.isLoading = true;
    fetch(url)
      .then(response => {
        if (response.ok) {
  ...
  editOutlet = () => async () => {
    this.setState({ isLoading: true });
    var url = `http://10.0.111.143:8083/UbahDataOutlet/${this.state.resultEyeout_code}`;
  ...
  editTelpon = async () => {
    this.setState({ isLoading: true });
    var url = `http://10.0.111.143:8083/UbahTeleponOutlet/${this.state.telout_runningid}`;
    console.log(url);
    var payload = {
      telout_outcode: this.state.telout_outcode,
  ...
  searchInputValue = () => {
    ...
    if (this.state.searchInputtedName.length !== 0) {
      this.setState({ isLoading: true });
      var url = `http://10.0.111.143:8083/CariDataOutlet/${this.state.searchInputtedName}`;
      fetch(url)
        .then(response => response.json())
        .then(data =>
  ...
  deleteOutlet = param => async () => {
    var url = `http://10.0.111.143:8083/HapusDataOutlet/${param}`;
    var payload = {
      out_userid: '0',
    };
    let data = await fetch(url, {
  ...
  deleteTelpon = () => async () => {
    this.isLoading = true;
    var url = `http://10.0.111.143:8083/HapusTeleponOutlet/${this.state.telout_runningid}`;
                    ...
                    <Col xs={5} md={5}>
                      <InputGroup>
                        <InputGroupAddon addonType="prepend">
                          <InputGroupText>
                            <Input
                              value={this.state.out_allowcredityn}
                        ...
                        <InputGroupAddon addonType="prepend">
                          <InputGroupText>
                            <Input
                              ...
                              value={this.state.out_perjanjianyn}
                            ...
                            <InputGroupAddon addonType="prepend">
                              <InputGroupText>
                                <Input
                                  ...
                                  addon
                                  checked={
                                    this.state.resultEyeout_robotgdynChecked
                                  }
                          ...
                          <InputGroupAddon addonType="prepend">
                            <InputGroupText>
                              <Input
                                ...
                                value={this.state.out_perjanjianyn}
                                onClick={event =>
                                  this.editAllowPerjanjian(event)
                                }
                                checked={this.state.out_perjanjianynChecked}
                                id="perjanjianYNChecbox"
                                addon
                    ...
                    <Row className="show-grid ">
                      ...
                      <Col xs={4} md={4}>
                        <FormGroup>
                          <Input
                            type="date"
                            onChange={evt => this.startDateInputChangeEdit(evt)}
                            id="tanggalBuka"
                            name="tanggalBuka"
                            required
                            class="datepicker-input"
                            value={this.state.dateopen}
                            disabled={
                              this.state.dateOpenIsNull &&
                              this.state.dateOpenValueEdit
                            }
                      ...
                      <Col xs={4} md={4}>
                        <Input
                          onChange={evt => this.endDateInputChangeEdit(evt)}
                          type="date"
                          id="tanggalTutup"
                          name="tanggalTutup"
                          defaultValue={dateClose}
                              ...
                              <InputGroupAddon addonType="prepend">
                                <InputGroupText>
                                  <Input
                                    ...
                                    checked={
                                      this.state.resultEyeout_jaminynSenin
                                    }
                                    id="jaminYNChecbox"
                                    addon
                                    type="checkbox"
                              ...
                              <InputGroupAddon addonType="prepend">
                                <InputGroupText>
                                  <Input
                                    ...
                                    checked={
                                      this.state.resultEyeout_jaminynRabu
                                    }
                                    id="jaminYNChecbox"
                                    addon
                                    type="checkbox"
                              ...
                              <InputGroupAddon addonType="prepend">
                                <InputGroupText>
                                  <Input
                                    ...
                                    checked={
                                      this.state.resultEyeout_jaminynKamis
                                    }
                                    id="jaminYNChecbox"
                                    addon
                                    type="checkbox"
                              ...
                              <InputGroupAddon addonType="prepend">
                                <InputGroupText>
                                  <Input
                                    ...
                                    checked={
                                      this.state.resultEyeout_jaminynJumat
                                    }
                                    id="jaminYNChecbox"
                                    addon
                                    type="checkbox"
                              ...
                              <InputGroupAddon addonType="prepend">
                                <InputGroupText>
                                  <Input
                                    ...
                                    checked={
                                      this.state.resultEyeout_jaminynSabtu
                                    }
                                    id="jaminYNChecbox"
                                    addon
                                    type="checkbox"
