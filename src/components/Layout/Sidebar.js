...
const navTeamADF= [
  ...
  { to: '/jenis-outlet', name: 'jenis outlet', exact: false, Icon: MdStore }, //MdStore
];

const navMasterOutlet=[
  { to: '/outlet', name: 'outlet', exact: false, Icon: MdStore }, //MdStore
  { to: '/outletschedule', name: 'schedule', exact: false, Icon: MdSchedule}, //MdSchedule
  ...
  // { to: '/outletaccountingpajak', name: 'accounting - pajak', exact: false, Icon: MdAttachMoney }, //MdAttachMoney
  { to: '/outletaccountingsupplier', name: 'accounting - supplier', exact: false, Icon: MdAttachMoney }, //MdAttachMoney
  { to: '/outletfinance', name: 'finance', exact: false, Icon: MdAttachMoney }, //MdAttachMoney
  { to: '/SPDO', name: 'spdo', exact: false,Icon: MdAttachMoney }, //MdEqualizer
]

const ProgramDiscount = [
  { to: '/ProgramDiscount', name: 'Program Discount', exact: false, Icon:  "none"}, //MdLocalPharmacy
